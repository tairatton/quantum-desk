...
- **Cost is spread + commission + slippage** (`strategy.config.COSTS`). Bars are bid-quoted, so a round trip pays the spread once; commission and slippage are absent from the feed and are modelled per symbol. The figures are estimates, not measurements - replace them with what an FTMO demo actually charges.
...
|---|---:|---|---:|---:|---:|---:|---:|---:|
| XAUUSD | M15 | BE + 33/33/34 + TP2 step | 248 | 47.98% | +43.67R | +0.18R/trade | 1.49 | 9.06R |
| XAUUSD | M30 | BE + 33/33/34 + TP2 step | 227 | 57.71% | +81.09R | +0.36R/trade | 2.07 | 6.09R |

### Production-aligned split results

| Symbol | TF | Split | Trades | Win rate | Net | Expectancy | PF | Max DD |
|---|---:|---|---:|---:|---:|---:|---:|---:|
| XAUUSD | M15 | Train | 752 | 48.14% | +129.39R | +0.17R/trade | 1.45 | 10.97R |
| XAUUSD | M15 | Validation | 226 | 54.42% | +74.07R | +0.33R/trade | 2.01 | 5.62R |
| XAUUSD | M15 | Holdout | 248 | 47.98% | +43.67R | +0.18R/trade | 1.49 | 9.06R |
| XAUUSD | M30 | Train | 693 | 46.75% | +36.94R | +0.05R/trade | 1.12 | 25.78R |
| XAUUSD | M30 | Validation | 225 | 52.44% | +46.88R | +0.21R/trade | 1.50 | 14.04R |
| XAUUSD | M30 | Holdout | 227 | 57.71% | +81.09R | +0.36R/trade | 2.07 | 6.09R |
...
|---|---:|---|---:|---:|---:|---:|---:|---|
| XAUUSD | M30 | BE + 33/33/34 + TP2 step | 227 | 57.71% | +81.09R | 2.07 | 6.09R | Yes |
| EURUSD | M30 | BE + 33/33/34 + TP2 step | 215 | 52.09% | +26.04R | 1.29 | 10.51R | No |
...
Selected exit: **BE + 33/33/34 + TP2 step**

| Split | Trades | Win rate | Net | Expectancy | PF | Max DD |
|---|---:|---:|---:|---:|---:|---:|
| Train | 693 | 46.75% | +36.94R | +0.05R/trade | 1.12 | 25.78R |
| Validation | 225 | 52.44% | +46.88R | +0.21R/trade | 1.50 | 14.04R |
| Holdout | 227 | 57.71% | +81.09R | +0.36R/trade | 2.07 | 6.09R |
...
|---|---:|---:|---|---:|---:|---:|---:|---:|
| XAUUSD | M5 | 50000 | BE + 33/33/34 + TP2 step | 239 | 47.70% | +31.36R | 1.38 | 9.51R |
| XAUUSD | M15 | 50000 | Full TP3 | 248 | 30.65% | +38.11R | 1.34 | 11.42R |
| XAUUSD | M30 | 50000 | BE + 33/33/34 + TP2 step | 227 | 57.71% | +81.09R | 2.07 | 6.09R |
| XAUUSD | H1 | 50000 | Full TP3 | 236 | 37.29% | +49.50R | 1.39 | 9.24R |
| XAUUSD | H4 | 15962 | BE + 33/33/34 + TP2 step | 73 | 61.64% | +24.09R | 1.92 | 4.02R |
| BTCUSD | M5 | 50002 | BE + 33/33/34 + TP2 step | 238 | 43.70% | +23.53R | 1.25 | 10.65R |
| EURUSD | M5 | 50000 | BE + 33/33/34 + TP2 step | 239 | 41.00% | -51.31R | 0.62 | 54.09R |
| EURUSD | M15 | 50000 | BE + 33/33/34 + TP2 step | 230 | 46.96% | +19.17R | 1.21 | 10.60R |
| EURUSD | M30 | 49625 | BE + 33/33/34 + TP2 step | 215 | 52.09% | +26.04R | 1.29 | 10.51R |
| EURUSD | H1 | 24813 | Regime adaptive | 97 | 41.24% | +2.56R | 1.05 | 14.33R |
| EURUSD | H4 | 6415 | Full TP3 | 28 | 28.57% | -1.07R | 0.94 | 5.50R |
| GBPUSD | M5 | 50000 | BE + 33/33/34 + TP2 step | 222 | 43.24% | -29.63R | 0.74 | 34.51R |
| GBPUSD | M15 | 50000 | BE + 33/33/34 + TP2 step | 207 | 46.86% | +2.65R | 1.03 | 11.94R |
| GBPUSD | M30 | 49625 | BE + 33/33/34 + TP2 step | 215 | 48.84% | +5.94R | 1.06 | 11.07R |
| GBPUSD | H1 | 24813 | Full TP3 | 107 | 29.91% | -5.43R | 0.92 | 17.13R |
| GBPUSD | H4 | 6415 | BE + 33/33/34 + TP2 step | 33 | 36.36% | -3.40R | 0.82 | 7.02R |
| USDJPY | M5 | 50000 | BE + 33/33/34 + TP2 step | 233 | 37.77% | -56.28R | 0.58 | 58.32R |
| USDJPY | M15 | 50000 | Full TP3 | 199 | 24.12% | -28.21R | 0.76 | 32.97R |
| USDJPY | M30 | 49625 | BE + 33/33/34 + TP2 step | 190 | 48.95% | +13.75R | 1.16 | 9.88R |
| USDJPY | H1 | 24813 | BE + 33/33/34 + TP2 step | 98 | 48.98% | +7.06R | 1.17 | 6.30R |
