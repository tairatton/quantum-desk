...
# (cwd one level too shallow, e.g. from bot/forex/) therefore cannot work --
...
if __package__ and __package__ != "entrypoints":
    raise SystemExit(
        ...
        "    cd bot/forex/core && python -m entrypoints.live\n"
        "or just double-click bot/forex/main.bat. Each tree is a separate import root."
    )
if not __package__:
