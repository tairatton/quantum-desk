...
`strategy.mt5_source.connection()` opens and shuts the terminal down per call, which
...
from engine.instrument import SymbolSpec
from strategy import config, mt5_source
